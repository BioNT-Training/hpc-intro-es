...
Cuando se le solicite, introduzca una contraseña segura teniendo en cuenta las [consideraciones anteriores](#consideraciones-sobre-las-contrasenas-de-las-claves-ssh). Ten en cuenta que el terminal no parecerá cambiar mientras escribes la contraseña: esto es deliberado, por tu seguridad. Se le pedirá que la escriba de nuevo, así que no se preocupe demasiado por los errores tipográficos.
...
- Cuando se le solicite, introduzca una contraseña segura teniendo en cuenta las [consideraciones anteriores](#consideraciones-sobre-las-contrasenas-de-las-claves-ssh).
