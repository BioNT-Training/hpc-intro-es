...
Abra el [HPC Jargon Buster](files/jargon.html#p1) en una nueva pestaña. Para presentar el contenido, pulse `C` para abrir un **c**lone en una ventana separada, después pulse `P` para cambiar el modo de **p**resentación.
